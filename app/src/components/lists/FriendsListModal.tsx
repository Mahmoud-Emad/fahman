/**
 * FriendsListModal - Modal for viewing friends list with tabs
 */
...
import { FriendItem, FriendRequestItem } from "@/components/friends/FriendItem";
import { FriendSkeletonList } from "@/components/friends/FriendItemSkeleton";
...
type TabId = "friends" | "requests" | "sent";

/**
 * FriendsListModal component
 *
 * Has three tabs (Friends, Requests, Sent) with different content per tab,
 * so it uses Modal directly with SegmentedControl rather than ListModal.
 */
export function FriendsListModal({
  ...
  return (
    <Modal visible={visible} onClose={onClose} title="Friends" padding="p-0">
      {/* Tabs */}
