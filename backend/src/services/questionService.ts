...
export class QuestionService {
   ...
   */
  async createQuestion(packId: string, userId: string, questionData: any) {
   ...
   * Update a question
   */
  async updateQuestion(questionId: string, userId: string, updateData: any) {
   ...
   */
  async bulkCreateQuestions(packId: string, userId: string, questions: any[]) {
    // Verify pack
    const pack = await prisma.pack.findUnique({
      where: { id: packId },
      include: {
