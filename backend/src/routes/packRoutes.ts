 ...
 */
router.get('/', packController.getPublicPacks);
 ...
 */
router.get('/my', authenticate, packController.getMyPacks);
 ...
 */
router.get('/system', packController.getSystemPacks);
 ...
 */
router.get('/popular', packController.getPopularPacks);
 ...
 *         description: Unauthorized
 */
router.get('/selection', authenticate, packController.getPacksForSelection);
 ...
 */
router.get('/:id', validateUUID('id'), packController.getPackById);
 ...
 *         description: Unauthorized
 */
router.post('/', authenticate, validate(createPackSchema), packController.createPack);
 ...
 */
router.delete('/:id', authenticate, validateUUID('id'), packController.deletePack);
 ...
 */
router.post('/:id/publish', authenticate, validateUUID('id'), packController.publishPack);
 ...
 */
router.get('/:packId/questions', validateUUID('packId'), questionController.getPackQuestions);
 ...
 */
router.delete('/questions/:id', authenticate, validateUUID('id'), questionController.deleteQuestion);
