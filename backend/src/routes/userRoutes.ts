...
import { validateQuery, validateUUID } from '../middlewares/validation';
import { searchUsersSchema, recentGamesSchema } from '../validators/userValidator';
 ...
 */
router.get('/search', authenticate, validateQuery(searchUsersSchema), friendController.searchUsers);
 ...
 *         description: Unauthorized
 */
router.get('/me/games/recent', authenticate, validateQuery(recentGamesSchema), userController.getRecentGames);
 ...
 *         description: Unauthorized
 */
router.get('/me/achievements', authenticate, userController.getUserAchievements);
 ...
 *         description: Unauthorized
 */
router.get('/:userId/games/recent', authenticate, validateUUID('userId'), validateQuery(recentGamesSchema), userController.getOtherUserRecentGames);
