...
import { cursorPaginationSchema } from '../validators/paginationValidator';
...
router.post(
  ...
  messageController.sendRoomInvite
);
 ...
 *         description: Unauthorized
 */
router.patch('/read', validate(markAsReadSchema), messageController.markAsRead);
 ...
 */
router.get('/room/:roomId', validateUUID('roomId'), validateQuery(cursorPaginationSchema), messageController.getRoomMessages);
 ...
 */
router.delete('/:id', validateUUID('id'), messageController.deleteMessage);
