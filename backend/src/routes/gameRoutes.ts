...
import { submitAnswerSchema } from '../validators/gameValidator';
 ...
 */
router.get('/', authenticate, gameController.getGameState);
 ...
 *         description: Room not found
 */
router.post('/answer', authenticate, validate(submitAnswerSchema), gameController.submitAnswer);
 ...
 *         description: Room not found
 */
router.post('/next', authenticate, gameController.nextQuestion);
 ...
 *         description: Room not found
 */
router.get('/results', authenticate, gameController.getResults);
...
router.get(
  ...
  gameController.getQuestionResults
);
