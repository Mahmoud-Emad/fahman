 ...
 *         description: Unauthorized
 */
router.get('/blocked', authenticate, friendController.getBlockedUsers);
 ...
 *         description: Unauthorized
 */
router.get('/status/:id', authenticate, validateUUID('id'), friendController.getFriendshipStatus);
 ...
 */
router.post('/request', authenticate, validate(sendFriendRequestSchema), friendController.sendFriendRequest);
...
router.post(
  ...
  friendController.sendFriendRequestByIdentifier
);
 ...
 */
router.post('/request/:id/accept', authenticate, validateUUID('id'), friendController.acceptFriendRequest);
 ...
 *         description: Request not found
 */
router.post('/request/:id/decline', authenticate, validateUUID('id'), friendController.declineFriendRequest);
 ...
 *         description: Request not found
 */
router.delete('/request/:id/cancel', authenticate, validateUUID('id'), friendController.cancelFriendRequest);
 ...
 */
router.delete('/:id', authenticate, validateUUID('id'), friendController.removeFriend);
 ...
 *         description: User not found
 */
router.post('/:id/block', authenticate, validateUUID('id'), friendController.blockUser);
 ...
 */
router.post('/:id/unblock', authenticate, validateUUID('id'), friendController.unblockUser);
