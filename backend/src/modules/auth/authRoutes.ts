 ...
 */
router.post('/register/phone', validate(registerWithPhoneSchema), asyncHandler(authController.registerWithPhone));
 ...
 */
router.post('/login/phone', validate(loginWithPhoneSchema), asyncHandler(authController.loginWithPhone));
 ...
 */
router.post('/login/game-id', validate(loginWithGameIdSchema), asyncHandler(authController.loginWithGameId));
 ...
 */
router.post('/google', validate(oauthLoginSchema), asyncHandler(oauthController.loginWithGoogle));
 ...
 *         description: Email already registered with different provider
 */
router.post('/facebook', validate(oauthLoginSchema), asyncHandler(oauthController.loginWithFacebook));
 ...
 */
router.post('/phone/send-code', validate(sendPhoneVerificationSchema), asyncHandler(phoneController.sendPhoneVerification));
 ...
 *         description: No account found with this phone number
 */
router.post('/phone/verify', validate(verifyPhoneSchema), asyncHandler(phoneController.verifyPhone));
 ...
 */
router.post('/forgot-password', validate(forgotPasswordSchema), asyncHandler(passwordController.forgotPassword));
 ...
 */
router.post('/reset-password', validate(resetPasswordSchema), asyncHandler(passwordController.resetPassword));
 ...
 *     description: Remove phone number from the authenticated user's account
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
