 ...
 */
router.get('/', authenticate, validateQuery(paginationSchema), asyncHandler(notificationController.getNotifications));
 ...
 */
router.patch('/:id/read', authenticate, validateUUID('id'), asyncHandler(notificationController.markAsRead));
 ...
 *         description: Unauthorized
 */
router.post('/room-invite', authenticate, validate(sendRoomInvitesSchema), asyncHandler(notificationController.sendRoomInvites));
 ...
 *         description: Notification not found
 */
router.patch('/:id/action', authenticate, validateUUID('id'), validate(resolveActionSchema), asyncHandler(notificationController.resolveAction));
 ...
 *         description: Unauthorized
 */
router.delete('/clear-read', authenticate, asyncHandler(notificationController.deleteReadNotifications));
 ...
 *         description: Notification not found
 */
router.delete('/:id', authenticate, validateUUID('id'), asyncHandler(notificationController.deleteNotification));
