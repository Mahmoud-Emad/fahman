 ...
 */
router.get('/', asyncHandler(roomController.getPublicRooms));
 ...
 */
router.get('/my', authenticate, asyncHandler(roomController.getMyRooms));
 ...
 */
router.get('/code/:code', asyncHandler(roomController.getRoomByCode));
 ...
 */
router.get('/search', asyncHandler(roomController.searchRooms));
 ...
 *         description: Room not found
 */
router.get('/:id', validateUUID('id'), asyncHandler(roomController.getRoomById));
 ...
 */
router.post('/', authenticate, validate(createRoomSchema), asyncHandler(roomController.createRoom));
 ...
 */
router.post('/join', authenticate, validate(joinRoomByCodeSchema), asyncHandler(roomController.joinRoomByCode));
 ...
 *         description: Room not found
 */
router.post('/:id/join', authenticate, validateUUID('id'), validate(joinRoomSchema), asyncHandler(roomController.joinRoom));
 ...
 */
router.post('/:id/leave', authenticate, validateUUID('id'), asyncHandler(roomController.leaveRoom));
 ...
 *         description: Room not found
 */
router.post('/:id/start', authenticate, validateUUID('id'), asyncHandler(roomController.startGame));
 ...
 *         description: Not in this room
 */
router.post('/:id/ready', authenticate, validateUUID('id'), validate(setReadySchema), asyncHandler(roomController.setReady));
 ...
 */
router.post('/:id/kick/:userId', authenticate, validateUUID('id'), validateUUID('userId'), asyncHandler(roomController.kickPlayer));
 ...
 *         description: Room not found
 */
router.patch('/:id', authenticate, validateUUID('id'), validate(updateRoomSchema), asyncHandler(roomController.updateRoom));
 ...
 *         description: Room not found
 */
router.delete('/:id', authenticate, validateUUID('id'), asyncHandler(roomController.deleteRoom));
